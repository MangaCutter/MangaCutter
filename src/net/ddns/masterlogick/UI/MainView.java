...
public class MainView {
    ...
    JCheckBox cutGradientCheckBox;
    JSlider toleranceSlider;
    JLabel toleranceLabel;
    JTextField asIsDirTextField;
    JButton asIsBrowseButton;
    JPanel asIsPanel;
    JLabel toleranceStaticLabel;
    ...
    public MainView() {
        ...
        startButton.addActionListener(e -> new Thread(() -> {
            ...
            switch (pathSelector.getSelectedIndex()) {
                case ViewManager.AS_IS_INDEX:
                    success = JobManager.startJob(urlTextField.getText(), asIsDirTextField.getText(),
                            "", pathSelector.getSelectedIndex(), false, 0);
                    break;
                case ViewManager.MULTI_INDEX:
                    success = JobManager.startJob(urlTextField.getText(), multiDirTextField.getText(),
                            perfectHeightTextField.getText(), pathSelector.getSelectedIndex(), cutGradientCheckBox.isSelected(), toleranceSlider.getValue());
                    break;
                case ViewManager.SINGLE_INDEX:
        ...
        asIsBrowseButton.addActionListener(e -> ViewManager.showAsIsFileChooser());
        cutGradientCheckBox.addActionListener(e -> {
            ViewManager.gradientCheckBoxSwitched();
        });
    }
